...
public class Ingreso_suministros extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlIngresarSumi.setBackground(new java.awt.Color(153, 51, 0));
        ...
        btnIngresarInsumo.setBackground(new java.awt.Color(0, 0, 51));
        ...
        jPanel1.add(btnIngresarInsumo, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 550, -1, -1));
        ...
        try {
            ...
            if (dia.isEmpty() || mes.isEmpty() || nombreInsuID.isEmpty() || inicial.isEmpty() || nombreInsumo.isEmpty() || tipoInsu.isEmpty()
                ...
                if (this.cbArea.getSelectedItem().equals("Servicio")) {
                    ...
                    suministros.registroTablaStockServicio(dia, mes, nombreInsuID, inicial, cantFinal, unidadM, porciones);
                ...
                if (this.cbArea.getSelectedItem().equals("Restaurante")) {
                    suministros.registroTablaStockRestaurante(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Personal")) {
                    suministros.registroTablaStockPersonal(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Bar")) {
                    porciones = Double.parseDouble(this.txtPorciones.getText());
                    suministros.registroTablaStockBar(dia, mes, nombreInsuID, inicial, cantFinal, unidadM, porciones);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Habitaciones")) {
                    suministros.registroTablaStockHabitacion(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Mantenimiento")) {
                    suministros.registroTablaStockMantenimiento(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Recepción")) {
                    suministros.registroTablaStockRecepcion(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
                ...
                if (this.cbArea.getSelectedItem().equals("Otros")) {
                    suministros.registroTablaStockOtros(dia, mes, nombreInsuID, inicial, cantFinal, unidadM);
                    JOptionPane.showMessageDialog(this, "Registro existoso\n"
