...
public class ConexionBD {
    ...
    public Connection obConexion() {
        try {
            conexionLocal = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/BDIKOOLEBIL", "root", "koolebil");
    ...
    public Connection obConexion2() {
        try {
            conexionLocal2 = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/BDIKOOLEBIL", "root", "koolebil");
